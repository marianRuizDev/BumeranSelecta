                ...
                <div class="row home">
                   {/*  <div className="col-sm-1">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div><img src={img7} className='candidatos' /></div>
                    </div>
                    <div class="col-sm-5">
                        <ul>
                            <li>
                                <FaLaptopCode className='iconos' /> Inteligencia Artificial vinculada al reclutador experto que mejor se adapta a la búsqueda.</li>
                            <li><BsNewspaper className='iconos' />
                                Públicaión del aviso en principales portales de empleo y universidades con el máximo destaque.</li>
